...
/// </summary>
public class UFOBGMManager : MonoBehaviour
{
    public static UFOBGMManager Instance { get; private set; }
    ...
    private void Awake()
    {
        // 将来的に他インスタンスが増えても既存のInstanceを奪わない（他のUFO系シングルトンと同じガード方式）
        if (Instance == null)
        {
            Instance = this;
        }
